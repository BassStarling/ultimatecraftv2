...
//TODO:エチルベンゼンは、主にエチレンを使用したベンゼンのアルキル化によって主に生成されます 、次の手順を含むプロセス：
//
//1。飼料準備： ベンゼンとエチレンは精製され、触媒と混合されます。
//
//2。アルキル化： 混合物は、高温（約400°C）および圧力（約40気圧）で、通常、ゼオライト、ゼオライトの固体触媒を含む反応器に通過します。これは、エチルベンゼンの形成につながります。
//
//3。分離と精製： 製品の流れは、未反応のベンゼンとエチレンから分離されます。エチルベンゼンは蒸留によってさらに精製されます。